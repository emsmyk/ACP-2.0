	...
	<div class="row">
            ...
            <p>
              <div class='form-group input-group'>
                ...
                <select class="form-control" name="sourcemod">
                  ...
                  <?
                  $source_wersje = SQL::all("SELECT * FROM `acp_sourceupdate` ORDER BY `id` DESC");
		...
		<div class="col-lg-3">
			<div class="box box">
				...
				<div class="box-body">
          <?
          $systemy_source = SQL::all("SELECT * FROM `acp_sourceupdate` ORDER BY `id` DESC LIMIT 5");
          foreach ($systemy_source as $key => $value) {
          ?>
          <div class="list-group">
            <a class="list-group-item list-group-item-action active">
              Data: <?= Date::relative($value->data) ?>
            </a>
		...
		<div class="col-lg-3">
          ...
          foreach ($servers->servers as $key => $value) {
            $source = SQL::row("SELECT * FROM `acp_serwery_update` WHERE `serwer_id` = $value->serwer_id LIMIT 1");
