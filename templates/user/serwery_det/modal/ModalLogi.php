  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?
        $logi_sm = json_decode(SQL::one("SELECT `dane` FROM `acp_cache_api` WHERE `get` = 'serwer_id".$serwer_id."_logs_sm' LIMIT 1"));
        $logi_source = json_decode(SQL::one("SELECT `dane` FROM `acp_cache_api` WHERE `get` = 'serwer_id".$serwer_id."_logs' LIMIT 1"));
        ?>
