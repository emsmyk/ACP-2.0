        ...
        <div class="tab-pane active" id="HexTags">
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?= Controller('ServerDet')->get_table_serwer_file('hextags', $serwer_id, $dostep->serwery_det_SerKonfiguracjaRangi, $dostep->serwery_det_SerKonfiguracjaALL); ?>
            </table>
          </div>
        </div>
        <div class="tab-pane" id="Reklamy">
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?= Controller('ServerDet')->get_table_serwer_file('reklamy', $serwer_id, $dostep->serwery_det_SerKonfiguracjaReklamy, $dostep->serwery_det_SerKonfiguracjaALL); ?>
            </table>
          </div>
        </div>
        <div class="tab-pane" id="BazyDanych">
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?= Controller('ServerDet')->get_table_serwer_file('bazydanych', $serwer_id, $dostep->serwery_det_SerKonfiguracjaBazy, $dostep->serwery_det_SerKonfiguracjaALL); ?>
            </table>
          </div>
        </div>
        <div class="tab-pane" id="Mapy">
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?= Controller('ServerDet')->get_table_serwer_file('mapy', $serwer_id, $dostep->serwery_det_SerKonfiguracjaBazy, $dostep->serwery_det_SerKonfiguracjaALL); ?>
            </table>
          </div>
        </div>
      </div>
