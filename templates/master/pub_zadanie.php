                  ...
                  <div class="col-lg-7">
                    ...
                    <div class="nav-tabs-custom">
                      ...
                      <div class="box-body chat" id="chat-box">
                        <?
                        $komentarze_q = SQL::all("SELECT *, (SELECT `login` FROM `acp_users` WHERE `user` = `u_id`) AS `nick`,
                    ...
                    <div class="nav-tabs-custom">
                      ...
                      <div class="tab-content">
                        <ul class="todo-list">
                          <?
                          $todo_q = SQL::all("SELECT * FROM `acp_zadania_todo` WHERE `zadanie_id` = $zadanie->id");
                    ...
                    <div class="nav-tabs-custom">
                      ...
                      <div class="tab-content">
                        <div class="logi_hight">
                          <? $logi_q = SQL::all("SELECT *,`user` AS `user_id`,(SELECT `login` FROM `acp_users` WHERE `user` = `user_id` LIMIT 1) AS `login` FROM `acp_log` WHERE `page` LIKE '%?x=zadania&xx=zadanie&id=$zadanie->id%' ORDER BY `id` DESC");
                    ...
                    <div class="nav-tabs-custom">
                      ...
                      <div class="box-body tab-content">
                        <?
                         ...
                         $zadanie->zlecajacy_blok_2 = (!empty($zadanie->zlecajacy)) ? Date::relative($zadanie->data) : '';
                         $zadanie->akcept_blok_1 = (!empty($zadanie->akceptujacy)) ? "<a href='#'>$zadanie->akceptujacy</a>" : '<a href="#">Brak</a>' ;
                         $zadanie->akcept_blok_2 = (!empty($zadanie->akceptujacy)) ? Date::relative($zadanie->a_data) : '';
                         ...
                         $zadanie->technik_blok_2 = (!empty($zadanie->technik)) ? Date::relative($zadanie->t_data) : '';
                        ?>
