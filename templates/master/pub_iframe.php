          ...
          <div class="box box-widget widget-user-2">
           ...
           <div class="box-footer no-padding">
             <ul class="nav nav-stacked">
               ...
               $i = 0;
               $gosetti = SQL::all("SELECT `gosetti_p_klik_tura`, `data` FROM `acp_serwery_gosetti` WHERE `serwer_id` = $value->serwer_id ORDER BY `acp_serwery_gosetti`.`data` DESC LIMIT 5");
