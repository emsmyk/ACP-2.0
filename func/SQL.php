...
class DB
{
    ...
    public function __construct($DB_HOST='localhost', $DB_USER='v55582717_acpSloneczny', $DB_PASS='sIRjK5NV', $DB_NAME='v55582717_updateacp')
    {
    ...
    public function get_results_new( $query, $object = false )
    {
        self::$counter++;
        //Overwrite the $row var to null
        $row = null;
